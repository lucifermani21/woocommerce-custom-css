    ...
    class MS_Custom_CSS_Setting{
		...
		public function MS_SASS_css_compiler(){
			...
			$plugin_css_variables = array(
				...
				'$product_title_size' => get_option( 'product_title_size' )."px",
				'$product_price_text' => get_option( 'product_price_text' ),
				'$product_price_size' => get_option( 'product_price_size' )."px",
				'$product_box_bor' => get_option( 'product_box_bor' )."px",
				'$product_box_bor_radis' => get_option( 'product_box_bor_radis' )."%",
				...
				'$btn_font_size' => get_option( 'btn_font_size' )."px",
				'$btn_bor_radius' => get_option( 'btn_bor_radius' )."%",
				'$table_border_size' => get_option( 'table_border_size' )."px",
