...
if (!class_exists('MS_Custom_CSS_Setting'))
{
    class MS_Custom_CSS_Setting
    {
        ...
        public function custom_plugin_min_css()
        {
            ...
            wp_register_style('woocustommincss', $plugin_URL, array(
                'woocommerce-general'
            ) , $version, 'all');
        ...
        public function MS_SASS_css_compiler()
        {
            ...
            $plugin_css_variables = array(
				...
				'$cat_title_size' => $this->get_option_size_data('cat_title_size') ,
				'$cat_title_fw' => get_option('cat_title_fw') ,
				'$cat_box_pading' => $this->get_option_dimension_data('cat_box_pading') ,
				'$cat_box_bor' => $this->get_option_border_data('cat_box_bor') ,
				'$cat_box_bor_radis' => $this->get_option_dimension_data('cat_box_bor_radis') ,
				...
				'$pro_detail_title_size' => $this->get_option_size_data('pro_detail_title_size') ,
				'$pro_detail_title_fw' => get_option('pro_detail_title_fw') ,
				'$pro_detail_price_text' => get_option('pro_detail_price_text') ,
				'$pro_detail_price_size' => $this->get_option_size_data('pro_detail_price_size') ,
