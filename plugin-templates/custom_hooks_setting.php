...
$settings = array(
	...
	array(
		'title' => __( 'Woo Shop Page Sale Counter', 'woocommerce-custom-settings-plugin' ),
		'desc' => __( 'Enable shop page product sale counter for sale strat and end dates.', 'woocommerce-custom-settings-plugin' ),
		'id' => 'woo_shop_sale_counter',
		'default'  => 'no',
		'type' => 'checkbox',                   
		//'desc_tip' => false,
	),
	array(
		'title' => __( 'Woo Product Page Sale Counter', 'woocommerce-custom-settings-plugin' ),
		'desc' => __( 'Enable product details page sale counter for sale strat and end dates.', 'woocommerce-custom-settings-plugin' ),
		'id' => 'woo_product_detail_sale_counter',
		'default'  => 'no',
		'type' => 'checkbox',                   
		//'desc_tip' => false,
	),
